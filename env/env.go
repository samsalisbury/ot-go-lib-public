...
//    package main
//
//    import "github.com/opentable/ot-go-lib-public/env"
//
//    var (
//        redisHost = env.RequireString("LOGGING_REDIS_HOST")
//        redisList = env.RequireString("LOGGING_REDIS_LIST")
//        redisPort = env.RequireInt("LOGGING_REDIS_PORT")
//    )
//
//    func main() {
